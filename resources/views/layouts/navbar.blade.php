            ...
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <button type="button" class="icon-button displayAnotherModel" data-bs-toggle="modal"
                        ...
                        <span class="icon-button__badge" id="countNoti">0</span>
                    </button>
                    @endauth
                    ...
                    <div class="menu_btn d-flex gap-2">
                        ...
                        <div class="modal fade noti" id="notificationModal" tabindex="-1"
                            aria-labelledby="notificationModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="notificationModalLabel">Notification Modal</h1>
                                        <button type="button" class="btn-close" id="closeNoti" data-bs-dismiss="modal"
